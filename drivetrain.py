...
slowVelocityGear = DriveGear("Slow Velocity", rev.ControlType.kVelocity,
    gearRatio=1/18.03, moveScale=5, turnScale=2.1, p=0.0000688, i=0.0000007, d=0.00001, f=0.0)
mediumVelocityGear = DriveGear("Medium Velocity", rev.ControlType.kVelocity,
    gearRatio=1/6.49, moveScale=6, turnScale=3, p=0.00007, i=0.0000007, d=0.00001, f=0.0)
